...
for i in range(200):
    ...
    for seg_i in val_idx:
        ...
        if flag:
            ...
            pd.DataFrame(feat_struct.featList).to_csv('2019_09_19_variable_names.csv',header=None,index=None)
            pd.DataFrame(feat_struct.featClass).to_csv('2019_09_19_variable_class.csv',header=None,index=None)
            pd.DataFrame(feat_struct.featHeightInvar).to_csv('2019_09_19_variable_Hinv.csv',header=None,index=None)
            pd.DataFrame(feat_struct.featSizeInvar).to_csv('2019_09_19_variable_sizeInv.csv',header=None,index=None)
            pd.DataFrame(feat_struct.featScale).to_csv('2019_09_19_variable_scale.csv',header=None,index=None)
            flag = False
        else:
...
# Save it all
pd.DataFrame(X).to_csv('2019_09_19_segment_features_1.csv',header=None,index=None)
pd.DataFrame(Y).to_csv('2019_09_19_cluster_labels_1.csv',header=None,index=None)
