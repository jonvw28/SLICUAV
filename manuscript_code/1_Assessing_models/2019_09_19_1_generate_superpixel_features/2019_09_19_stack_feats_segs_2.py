...
# Save it all
pd.DataFrame(X).to_csv('2019_09_19_segment_features_2.csv',header=None,index=None)
pd.DataFrame(Y).to_csv('2019_09_19_cluster_labels_2.csv',header=None,index=None)
