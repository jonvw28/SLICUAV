...
setwd("E:/SLICUAV_manuscript_code/1_Assessingmodels/2020_04_21_1_crown_cv_tests/SVM")
...
write.csv(res_table,'2020_04_21_SVM_accuracies_in_10fold_CV.csv')
write.csv(pred_table_all,'2020_04_21_SVM_predictions_all_model_10fold.csv')
write.csv(pred_table_sen,'2020_04_21_SVM_predictions_drop_sen_10fold.csv')
write.csv(pred_table_ran,'2020_04_21_SVM_predictions_drop_sen_pul_10fold.csv')