...
preds_table <- data.frame(ttagstring = Y[good_MS_mask,2],cluster = Y[good_MS_mask,3],label = Y[good_MS_mask,1],
                          ...
                          label_ran = temp_vec,
                          split = temp_vec,
                          band_feats_noMS_imagery_all = temp_vec,
                          band_feats_noMS_imagery_mods = temp_vec,
                          band_feats_noMS_imagery_sen = temp_vec,
                          band_feats_noMS_imagery_modsp = temp_vec,
                          band_feats_noMS_imagery_ran = temp_vec,
                          stringsAsFactors = F
                          )
...
# 
var_mask <-intersect(band_vars,union(rgb_vars,dsm_vars))
mod_string <- 'band_feats_noMS_imagery'
