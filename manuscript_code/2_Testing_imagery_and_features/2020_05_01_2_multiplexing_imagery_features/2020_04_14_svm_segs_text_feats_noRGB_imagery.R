...
preds_table <- data.frame(ttagstring = Y[good_MS_mask,2],cluster = Y[good_MS_mask,3],label = Y[good_MS_mask,1],
                          ...
                          label_ran = temp_vec,
                          split = temp_vec,
                          text_feats_noRGB_imagery_all = temp_vec,
                          text_feats_noRGB_imagery_mods = temp_vec,
                          text_feats_noRGB_imagery_sen = temp_vec,
                          text_feats_noRGB_imagery_modsp = temp_vec,
                          text_feats_noRGB_imagery_ran = temp_vec,
                          stringsAsFactors = F
                          )
...
# 
var_mask <-intersect(text_vars,union(ms_vars,dsm_vars))
mod_string <- 'text_feats_noRGB_imagery'
