...
preds_table <- data.frame(ttagstring = Y[good_MS_mask,2],cluster = Y[good_MS_mask,3],label = Y[good_MS_mask,1],
                          ...
                          label_ran = temp_vec,
                          split = temp_vec,
                          all_feats_noDSM_imagery_all = temp_vec,
                          all_feats_noDSM_imagery_mods = temp_vec,
                          all_feats_noDSM_imagery_sen = temp_vec,
                          all_feats_noDSM_imagery_modsp = temp_vec,
                          all_feats_noDSM_imagery_ran = temp_vec,
                          stringsAsFactors = F
                          )
...
# no DSM
var_mask <-union(rgb_vars,ms_vars)
mod_string <- 'all_feats_noDSM_imagery'
