...
grid_shps = gpd.read_file('E:/SLICUAV_manuscript_data/7_Clipped_OMs/'+
                         '2019_08_30_basecamp_grid/'+
                         '2019_08_30_basecamp_50m_grid.shp')

ftprnt_shp = gpd.read_file('E:/SLICUAV_manuscript_data/6_Harapan_shapefiles/'+
                           '2019_09_19_basecamp_footprint_both_years_latlong.shp')

flag = True
#for shp_i in range(all_shps.shape[0]):
for i in range(grid_shps.shape[0]-600):
    shp_flag = True
    random.seed(42)
    shp_i = i + 600
